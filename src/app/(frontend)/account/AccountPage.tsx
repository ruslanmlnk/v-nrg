...
const orderStatusIconMap: Record<OrderStatusIconKey, () => ReactNode> = {
  ...
  delivered: StatusDeliveredIcon,
  pending: StatusPendingIcon,
  shipped: StatusShippedIcon,
}
        ...
        <section className="grid gap-5 xl:grid-cols-[400px_minmax(0,1fr)]">
          ...
          >
            {activeSection === 'orders' ? (
              <>
                <SectionCard icon={<HistoryIcon />} title={accountSectionTitles.orders}>
            ...
            {activeSection === 'profile' ? (
              <SectionCard icon={<ProfileIcon />} title={accountSectionTitles.profile}>
            ...
            {activeSection === 'addresses' ? (
              <SectionCard icon={<AddressIcon />} title={accountSectionTitles.addresses}>
                <EmptyState
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-wrap items-center gap-4 text-[16px] font-medium leading-[165%] text-[#22354A]">
              <InfoPill icon={<CalendarIcon />}>
                {order.createdAt || accountFallbacks.unknownDate}
              </InfoPill>
              {order.trackingNumber ? (
                <InfoPill icon={<TruckBadgeIcon />}>
