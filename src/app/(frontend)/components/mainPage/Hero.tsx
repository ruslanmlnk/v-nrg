...
const Hero = () => {
  return (
    <section className="mx-auto md:mt-5 mt-[23px] max-w-[1288px] grid grid-cols-1 gap-5 px-6 md:grid-cols-2">
      <div className="rounded-[20px] bg-[#22354A] md:pl-8 md:pr-7 md:py-12 pl-6 pr-6 py-8">
        <div>
        ...
        <ArrowPillButton className="mt-6 md:mt-[164.5px]">Отримати консультацію</ArrowPillButton>
      </div>
